...
const NursingPostBasic = ({form_data}) => {
  ...
  return (
    <div className='NursingPostBasic'>
        <div className="register" style={{ maxWidth: "100%" }}>
            <h3>Post Basic BSc. Nursing Application Form</h3>
            <form>
              <div className="row">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <input
                            required type="number"
                            value={info?.phyp_obtained}
                            readOnly={true}
                            // onChange={(e) => setInfo({ ...info, phyp_obtained: e.target.value })}
                            name="phyp_obtained"
                            id="phyp_obtained"
                            className="form-control"
                          />
              ...
              <div className="row mt-5">
                ...
                <div className="col-md-3">
                  <div className="form-group">
                    ...
                    type="file" 
                    className="form-control" 
                    value={info?.three_year_markssheet}
                    readOnly={true}
                    // onChange={(e) => setInfo({ ...info, three_year_markssheet: e.target.value })}
                    name="marksheet" />
...
export default NursingPostBasic