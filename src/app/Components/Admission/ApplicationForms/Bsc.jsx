          ...
          <div className="form-group ">
            <div className="form-check form-check-inline">
              ...
              >
                ...
                or practical class or both is not as per Swaminarayan University
                rules. Shree Swaminarayan Science College has all right to
                cancel any admission or withdraw my examination form and I will
        ...
        <div className="col-md-12">
          ...
          <ol>
            ...
            <ul style={{ listStyleType: "square" }} stat="A">
              <li>
                Duly attested photocopies of marksheet of HSC and SSC / Previous
                examination (Semester) marksheet.
              </li>
              <li>
            ...
            <li>
              It is compulsory to keep college Identity Card, without which the
              student may not be allowed to enter the premises and the college
              building
            </li>
          </ol>
          <p />
