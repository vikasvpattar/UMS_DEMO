        ...
        <form>
          ...
          <div className="row mt-5">
            ...
            <div className="col-md-3">
              <div className="form-group">
                ...
                >
                  {" "}
                  <i class="ri-error-warning-line"></i> include all Marksheet in
                  one PDF
                </span>
              </div>
            </div>
          ...
          <div className="row mt-5">
            <p className="mt-2">
              ...
              form. I shall provide proof of my eligibility. I accept the rules
              of the university and shall not raise any dispute in future about
              the rules. In the event of any information being found incorrect
              or misleading my candidature is liable to be cancelled by the
              University any time and shall NOT entitle me for refund of any fee
              paid by me to the university. I accept the allotment of study
