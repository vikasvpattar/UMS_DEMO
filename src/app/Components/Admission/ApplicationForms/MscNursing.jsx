          ...
          <div className="register" style={{ maxWidth: "100%" }}>
            <form action="">
              ...
              <div className="row">
                ...
                <div className="col-md-4 mt-3">
                  <div className="form-group">
                    <label htmlFor="">Previous Degree</label>
                    <select
                      className="form-control"
                      name="stream"
                      value={info?.degree}
                      readOnly={true}
                    >
                      <option value="Science">Bsc Nursing</option>
                      <option value="Commerce">Post Basic Bsc Nursing</option>
                    </select>
                  </div>
                </div>
                      ...
                      <tr>
                        ...
                        <th>
                          <input
                            ...
                            name="max_internal_3"
                            value={
                              info?.max_internal_4 ? info?.max_internal_4 : ""
                            }
                            readOnly={true}
                          />
                        </th>
                        <th>
                          <input
                            ...
                            name="max_external_3"
                            value={
                              info?.max_external_4 ? info?.max_external_4 : ""
                            }
                            readOnly={true}
                          />
                        </th>
                  ...
                  <table className="table table-bordered text-center mt-3">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          {info?.marks_card_1 ? (
                            <a href={info?.marks_card_1} target="_blank">
                              <i className="ri ri-attachment-line"></i>
                            </a>
                          ) : (
                            <span className="badge badge-soft-info">
                      ...
                      <tr>
                        ...
                        <td>
                          {info?.marks_card_2 ? (
                            <a href={info?.marks_card_2} target="_blank">
                              <i className="ri ri-attachment-line"></i>
                            </a>
                          ) : (
                            <span className="badge badge-soft-info">
                      ...
                      <tr>
                        ...
                        <td>
                          {info?.marks_card_3 ? (
                            <a href={info?.marks_card_3} target="_blank">
                              <i className="ri ri-attachment-line"></i>
                            </a>
                          ) : (
                            <span className="badge badge-soft-info">
                      ...
                      {info?.degree == "bsc_nursing" ? (
                        <tr>
                          ...
                          <td>
                            {info?.marks_card_4 ? (
                              <a href={info?.marks_card_4} target="_blank">
                                <i className="ri ri-attachment-line"></i>
                              </a>
                            ) : (
                              <span className="badge badge-soft-info">
