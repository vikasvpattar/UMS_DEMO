...
function ModalPayRollBonus({ type, data, reloadData, setLoading }) {
    ...
    const handleSubmit = async () => {
        ...
        const config = {
            ...
            url: `${PAYROLL_BONUS}${type === 'edit' ? '/' + data.id : ''}`,
            headers: {
    ...
    return (
        <div className='ModalPayRollBonus'>
            <div
                className="modal fade"
                id="ModalPayRollBonus"
                tabIndex={-1}
                role="dialog"
...
export default ModalPayRollBonus