...
function ModalJobPositions(props) {
    console.log(props);
    ...
    const config = {
        ...
        url: `${JOB_POSITIONS}${props.type==='edit'?'/'+props.data.id:''}`,
        headers: {
    ...
    const SubmitModal = async () => {
        ...
        .then((res) => {
                ...
                clearData()
                props.reloadData();
                toast.success("new Job Position added successfully")
            })
            .catch(err => {
                props.setLoading(0)
                console.log(err)})
    ...
    return (
        <div className='ModalJobPositions'>
            <div
                className="modal fade"
                id="ModalJobPositions"
                tabIndex={-1}
                role="dialog"
                ...
                >
                    <div className="modal-content ">
                        <div className="modal-header">
                            ...
                            {props.type==='edit'?'Edit':'Add'} Job Position
                            </h5>
                            <button
                                type="button"
                                className="close"
...
export default ModalJobPositions