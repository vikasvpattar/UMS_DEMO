...
function ModalCollegeType(props) {
    ...
    const config = {
        ...
        url: `${COLLEGE_TYPE}${props.type==='edit'?'/'+props.data.id:''}`,
        headers: {
    ...
    const SubmitModal = async () => {
        ...
        await axios(config)
            .then((res) => {
                ...
                clearData()
                props.reloadData();
                toast.success("College Type Updated Succcessfully")
            })
            .catch(err =>{
                props.setLoading(0)
                console.log(err)})
                    ...
                    <div className="modal-content ">
                        <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalLongTitle">
                                {props.type==='edit'?'Edit':'Add'} College Type
                            </h5>
                            <button
                                type="button"
                                className="close"
...
export default ModalCollegeType