...
import ModalPayRollBonus from '../../../../modals/HR/PayRoll/ModalPayRollBonus'
import { PAYROLL_BONUS } from '../../../../utils/apiConstants'
import Nodata from '../../../../Components/NoData/Nodata'

function PayRollBonus({setLoading}) {
  ...
  return (
    <div className='PayRollBonus'>
        <div className="main-content">
            <ModalPayRollBonus type={type} data={edit} reloadData={getData} setLoading={setLoading}/>
                                ...
                                <div className="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <div className="page-title-right">
                                        <ol className="breadcrumb m-0">
                                            ...
                                            <li className="breadcrumb-item active">Bonus</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
