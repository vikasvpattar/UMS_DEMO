...
function EditStaff({setLoading, collegeId}) {
  ...
  <div className="page-content">
    <div className="container-fluid">
      ...
      {tab==='Basic'&&<StaffBasic tab={tab} id={id} setLoading={setLoading} collegeId={collegeId}/>}
      {tab==='Placement'&&<StaffPlacement id={id} tab={tab} setLoading={setLoading}/>}
      {tab==='Employment Terms'&&<StaffEmploymentTerms id={id} tab={tab} setLoading={setLoading}/>}
      {tab==='Education'&&<StaffEducation tab={tab} id={id} setLoading={setLoading}/>}
      {tab==='Experience'&&<StaffExperience tab={tab} id={id} setLoading={setLoading}/>}
      {tab==='Training'&&<StaffTraining tab={tab} id={id} setLoading={setLoading}/>}
      {tab==='Document'&&<StaffLegalDocs tab={tab} id={id} setLoading={setLoading}/>}
      {tab==='Publications'&&<StaffPublications tab={tab} id={id} setLoading={setLoading}/>}
