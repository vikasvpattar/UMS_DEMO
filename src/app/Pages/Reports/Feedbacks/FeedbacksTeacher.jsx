...
import {
    ...
    REPORT_TEACHERS_FECTH
  } from "../../../utils/Reports.apiConst";

import { useDownloadExcel } from "react-export-table-to-excel";
import { useRef } from "react";

const FeedbacksTeacher = ({ setLoading, collegeId }) => {
    ...
    const [teachersOpt, setTeachersOpt] = useState([]);
    ...
    const getAllData = async () => {
        ...
        const [data1, data2, data3] = await Promise.all([
          ...
          await axios({
            ...
            .then((res) => {
              // console.log('semester data - ', res.data.data);
          ...
          await axios({
            ...
            .then((res) => {
              // console.log('section data - ', res.data.data);
    ...
    const fetchTeachers = async() => {
        ...
        const config = {
            ...
            url: `${REPORT_TEACHERS_FECTH}`,
            data:obj
        };

        await axios(config)
          .then((res) => {
            console.log('Teachers data - ', res.data.data);
          ...
          if(!session || !faculty || !currentclass) {
            toast("Please Fill the Details");
            setLoading(0);
            return;
          }
          let obj1 = {};
          obj1['feedback_type'] = "teachers";
          const config1 = {
              method: "post",
              headers: {
                Authorization: `Bearer ${sessionStorage.getItem("UMS_auth")}`,
    ...
    const getFeedbackData = async() => {
        ...
        let obj = {};
        obj['feedback_type'] = "teachers";
        obj['semester_id'] = currentSemester;
        obj['session'] = session;
        obj['department_id'] = faculty;
        obj['class_id'] = currentclass;
        obj['section_id'] = currentSection;
        obj['emp_id'] = teacherId;
        const config = {
            method: "post",
            headers: {
              Authorization: `Bearer ${sessionStorage.getItem("UMS_auth")}`,
          ...
          .then((res) => {
            ...
            console.log('feedback suggestions - ', res.data.suggestions);
    ...
    useEffect(()=> {
      ...
      let temp = teachersData.filter((s)=>s.semester_id == currentSemester);
      setTeachers(temp);
    },[currentSemester]);

    useEffect(()=> {
      if(!currentSection) return;
      let temp = teachersData.filter((s)=> s.section_id == currentSection);
      setTeachers(temp);
    },[currentSection]);
    ...
    useEffect(()=> {
      ...
      if(suggestions?.length != 0) {
        temp.push({"s_no":"Staff Name : ", "suggestion":teachers?.find((s)=> s.emp_id == teacherId)?.name?teachers?.find((s)=> s.emp_id == teacherId)?.name:""})
        suggestions.map((v,i)=> {
          let obj = {
            "s_no":i+1,
            "suggestion":v
    ...
    <div className="main-content">
        <h6 className="my-0"><b>TEACHERS FEEDBACK</b></h6>
                        ...
                        <div className="card">
                            ...
                            <div className="row justify-content-end align-items-end">
                              ...
                              {/* <div className="row d-flex ">
                                ...
                                <div className="table-responsive">
                                    ...
                                    <thead>
                                      <tr>
                                        ...
                                        <td colSpan={4}><b>Staff name : {teachers?.find((s)=> s.emp_id == teacherId)?.name?teachers?.find((s)=> s.emp_id == teacherId)?.name:""}</b></td>
                                      </tr>
                                    </thead>
                                    <thead>
                                    <tr>
                                    ...
                                    <tbody>
                                      ...
                                      {feedbackQuestions && feedbackQuestions.length > 0 ? (
                                        <tr>
                                          ...
                                          <td>{suggestionsDisplay.length-1 > 0 ?suggestionsDisplay.length-1:0}</td>
                                ...
                                {/* <Button type="primary" onClick={() => setOpen(true)}>Show Suggestions</Button> */}
                                <Modal
                                  title="Suggestions"
                                  centered
                                  open={open}
...
export default FeedbacksTeacher;