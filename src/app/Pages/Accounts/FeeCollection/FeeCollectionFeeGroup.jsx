...
import { ACCOUNT_FEE_GROUP } from '../../../utils/Accounts.apiConst'
import { useEffect } from 'react'
import { useRef } from 'react'
import { scrollToRef } from '../../../Helpers/ScrollToRef'


function FeeCollectionFeeGroup({setLoading, collegeId}) {
  ...
  const [edit, setEdit] = useState(false)
    ...
    const checkRequiredFields = () => {
      if(!user.name||!user.description) return false;
      return true;
    }
    ...
    const getData = async() => {
      ...
      const config = {
        method: 'get',
        url: `${ACCOUNT_FEE_GROUP}?college_id=${collegeId}`,
        headers: {
    ...
    const handleSubmit = async() =>{
      if(!checkRequiredFields()) return toast.error("All Fields Are Required")
      setLoading(1)
  ...
  return (
    <div className='FeeCollectionFeeGroup'>
      ...
      <div className="row">
        <div className="col-12">
          <div className="page-title-box d-flex align-items-center justify-content-between">
            <h4 className="mb-0">Add Fee Groups</h4>
            <div className="page-title-right">
              <ol className="breadcrumb m-0">
                <li className="breadcrumb-item">
                  <a href="javascript: void(0);">Fee Collection</a>
                </li>
                <li className="breadcrumb-item active"> Fee Group</li>
              </ol>
            </div>
          </div>
        </div>
          ...
          <div className="card">
            <div className="card-body">
              <div className="row">
                <div className="col-md-4">
                  {" "}
                  <h4 className="card-title">Fee Groups Lists</h4>
                </div>
...
export default FeeCollectionFeeGroup