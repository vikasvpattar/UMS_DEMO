      ...
      <div className="container" style={{ padding: "20px" }}>
        <div className="row">
          <div className="col-6" style={{ padding: "20px" }}>
            ...
            <div className="row">
              ...
              <div className="col-9">
                ...
                <div style={{ textAlign: "center", fontSize: "17px" }}>
                  {collegeOpt?.find((s) => s.id == subData?.college_id)?.name}
                </div>
                <div style={{ textAlign: "center", fontSize: "17px" }}>
                   +91 8908908908
                </div>
            ...
            <div className="row mt-2">
              ...
              <div className="col-12 row">
                <div className="col-6">
                  ...
                  <div>Year : {mainData[0]?.year}</div>
                  {/* <div>Session : {mainData[0]?.session_id}</div> */}
                </div>
                <div className="col-6">
                  <div>
                    Date :{" "}
              ...
              <div className="col-12">
                <div>
                  <b>Enrollment No: {mainData[0]?.user_id}</b>
                </div>
              </div>
            </div>
            <div className="row mt-3 bg-dark py-2">
            ...
            >
              <div className="col-12 row mb-2" style={{ maxHeight: "20px" }}>
                <div
                  className="col-9"
            ...
            <div className="row mb-5">
              ...
              <div className="col-12">
                ...
                {empData?.filter((s) => s.id == data?.collected_by)[0]
                  ?.first_name +
                empData?.filter((s) => s.id == data?.collected_by)[0]?.last_name
                  ? empData?.filter((s) => s.id == data?.collected_by)[0]
                      ?.first_name +
                    empData?.filter((s) => s.id == data?.collected_by)[0]
                      ?.last_name
