...
function DesignMarkscard() {
  return (
    <div ClassName ="DesignMarkscard">
      ...
      <div className="row">
        <div className="col-12">
          <div className="page-title-box d-flex align-items-center justify-content-between">
            <h4 className="mb-0">Marks Card </h4>
            <div className="page-title-right">
              <ol className="breadcrumb m-0">
                <li className="breadcrumb-item">
                  <a href="javascript: void(0);">Examinations</a>
                </li>
                <li className="breadcrumb-item active"> Marks Card</li>
              </ol>
            </div>
          </div>
        </div>
            ...
            <div className="card-body">
              ...
              <br />
                <div className="row">
                  ...
                  <div className="col-md-3">
                    <div className="form-group">
                      <label htmlFor="">Printing Date</label>
                      <input
                        type="date"
                        className="form-control  "
                        id="print_date"
                  ...
                  <div className="col-md-3">
                    <div className="form-group">
                      <label htmlFor="">Left Signature</label>
                      <input
                        type="file"
                        className="form-control  "
                        id="lsign"
                  ...
                  <div className="col-md-3">
                    <div className="form-group">
                      <label htmlFor="">Middle Signature</label>
                      <input
                        type="file"
                        className="form-control  "
                        id="msign"
                  ...
                  <div className="col-md-3">
                    <div className="form-group">
                      <label htmlFor="">Right Signature</label>
                      <input
                        type="file"
                        className="form-control  "
                        id="rsign"
...
export default DesignMarkscard