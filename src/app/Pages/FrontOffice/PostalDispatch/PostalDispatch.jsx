...
import ModalPostalDispatch from "../../../modals/FrontOffice/ModalPostalDispatch";
...
import "./PostalDispatch.scss";

function PostalDispatch({ setLoading, collegeId }) {
  ...
  //   const config = {
  //     method: "get",
  //     url: `${FRONT_OFFICE_POSTAL}?type=DISPATCH`,
  //     headers: {
            ...
            <div className="row">
              <div className="col-12">
                <div className="page-title-box d-flex align-items-center justify-content-between">
                  <h4 className="mb-0">Add Postal Dispatch</h4>
                  ...
                  <div className="card-body">
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-3">
                        <div className="form-group">
                          <label htmlFor="validationCustom02">
                            To Title <span style={{ color: "red" }}>*</span>
                          </label>
                          <input
                            type="text"
                            className="form-control"
                      ...
                      <div className="col-md-3">
                        <div className="form-group">
                          <label htmlFor="validationCustom02">From Title</label>
                          <input
                            type="text"
                            className="form-control"
                            placeholder="Enter From title"
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      <button
                        onClick={() => {
                          navigate(
                            ROUTES.Registar.frontOffice
                              .ViewPostalDispatchRecieve
                          );
                        }}
