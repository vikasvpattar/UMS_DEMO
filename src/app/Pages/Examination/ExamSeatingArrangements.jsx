...
import ModalCreateSeatingArreangements from '../../modals/Examinations/ModalCreateSeatingArreangements'



function ExamSeatingArrangements() {
    ...
    const [info, setInfo] = useState(
      ...
      const [infoData, setInfoData] = useState([
        ...
        sem:"1st Semester",
        status:<p className='badge badge-soft-success'>Created</p>
          },
          {
            course: "UG",
          ...
          sem:"1st Semester",
          status:<p className='badge badge-soft-danger'>Not-Created</p>
            },
      ])
  ...
  return (
    <div className="ExamSeatingArrangements">

    <ModalCreateSeatingArreangements />
        ...
        <div className="row">
          <div className="col-12">
            <div className="page-title-box d-flex align-items-center justify-content-between">
              <h4 className="mb-0">Create Seating Arrangements</h4>
                        ...
                        infoData && infoData?.map((data, key) => {
                          return <tr key={key}>
                            ...
                            <td>   <a data-toggle="modal"
                                                    data-target="#create"  className='badge badge-light text-dark mr-3'  title="Edit"> <i class="fa fa-plus " aria-hidden="true"></i></a>
...
export default ExamSeatingArrangements