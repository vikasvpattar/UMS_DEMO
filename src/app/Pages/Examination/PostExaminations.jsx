...
import ModalPostExaminations from '../../modals/Examinations/ModalPostExaminations'





function PostExaminations() {
    ...
    const [info, setInfo] = useState(
      ...
      const [infoData, setInfoData] = useState([
        ...
        sem:"1st Semester",
        status:<p className='badge badge-soft-success'>Completed</p>
          },
          {
            course: "UG",
          ...
          sem:"1st Semester",
          status:<p className='badge badge-soft-danger'>Notcompleted</p>
            },
      ])
  ...
  return (
    <div className="PostExaminations">

    <ModalPostExaminations />
        ...
        <div className="row">
          <div className="col-12">
            <div className="page-title-box d-flex align-items-center justify-content-between">
              <h4 className="mb-0">Post-Examinations</h4>
...
export default PostExaminations