...
const navigate=useNavigate();
  ...
  return (
    <div className="DownloadHallTicket">
        ...
        <div className="row">
          <div className="col-12">
            <div className="page-title-box d-flex align-items-center justify-content-between">
              <h4 className="mb-0">Download Admit Card</h4>
...
<button onClick={()=> {navigate(ROUTES.Examination.Hallticket)}} className='btn btn-primary btn-sm'><i className='fa fa-download'></i> Download Admit Card</button>
</div>                <hr />
