...
import { STUDENTS_LIST_GET, STUDENTS_LIST_PUT } from '../../utils/InfoUploadingApiConstants';


function ViewHomeoStudentsList({ setLoading }) {
    ...
    const next = async (id, data1, images) => {
        ...
        navigate(`/Homoeopathy/StudentsListHomeo/${id}`, {
            state: {
                images: images,
                data: data1,
            },
...
export default ViewHomeoStudentsList;