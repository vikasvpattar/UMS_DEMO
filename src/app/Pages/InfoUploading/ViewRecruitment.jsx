...
import { RECRUITMENT_GET, RECRUITMENT_PUT } from '../../utils/InfoUploadingApiConstants';
...
function ViewRecruitment({ setLoading }) {
    ...
    const next = async (id, data1, images) => {
        ...
        navigate(`/TopNav/Recruitment/${id}`, {
            state: {
                images: images,
                data: data1,
            },
            ...
            <div className="container register">
                <div className="row">
                    <div class="card-header">
                        <h1 class="text-danger"> Recruitments </h1>
                    </div>
